...
- /new → Create a new document`,
    ...
    correction: {
      ...
      btnVendor: '🏢 Vendor',
      btnCancel: '✖ Cancel',
      promptAmount: 'Please enter the correct amount (e.g. 200 or 1500.50):',
      ...
      invalidAmount: '❌ Invalid amount. Please enter a positive number (e.g. 200 or 1500.50):',
...
- /new - צרו מסמך חדש`,
    ...
    correction: {
      ...
      btnVendor: '🏢 ספק',
      btnCancel: '✖ ביטול',
      promptAmount: 'אנא הזן את הסכום הנכון (לדוגמה: 200 או 1500.50):',
      promptDate: 'אנא הזן את התאריך הנכון בפורמט DD/MM/YYYY (לדוגמה: 15/01/2026):',
      promptVendor: 'אנא הזן את שם הספק הנכון:',
      invalidAmount: '❌ סכום לא תקין. אנא הזן מספר חיובי (לדוגמה: 200 או 1500.50):',
